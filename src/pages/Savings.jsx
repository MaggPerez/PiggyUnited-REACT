        ...
        <>
            ...
            <main className="main">
                ...
                <div className="transaction-container">
                    ...
                    <AmountButton activateActive={isActive} activateHandleClick={handleClick} />

                    <div className="transaction-box">
                        <h2 id="transactions-status">Enter Amount</h2>
                        <input type="number" className="input-box" name="Amount" id="amount-field"
                        value={userAmount}
